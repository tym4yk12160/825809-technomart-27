  ...
  linklesson.addEventListener("click", function(a) {
    ...
    form.addEventListener("submit", function(a) {
      login.value && email.value && textletter.value
        ...
        : (a.preventDefault(), lesson.classList.add("modal-error"));
    }),
    window.addEventListener("keydown", function(a) {
      27 === a.keyCode &&
        lesson.classList.contains("modal-content-show") &&
        (lesson.classList.remove("modal-content-show"),
        lesson.classList.remove("modal-error"));
    });
}
for (var i = 0; i < linkbuy.length; i++)
  linkbuy[i].addEventListener("click", function(a) {
...
closebuy.addEventListener("click", function(a) {
  ...
  window.addEventListener("keydown", function(a) {
    27 === a.keyCode &&
      buy.classList.contains("modal-content-show") &&
      buy.classList.remove("modal-content-show");
  }),
  linkmap.addEventListener("click", function(a) {
    a.preventDefault(), map.classList.add("modal-content-show-map");
  }),
  closemap.addEventListener("click", function(a) {
    a.preventDefault(), map.classList.remove("modal-content-show-map");
  }),
  window.addEventListener("keydown", function(a) {
    27 === a.keyCode &&
      map.classList.contains("modal-content-show-map") &&
